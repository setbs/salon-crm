...
Дополнение 2026-09-06: реализация резервов, идемпотентности и платёжных попыток H5/H6 описана в [order-payment-lifecycle-h5-h6.md](./order-payment-lifecycle-h5-h6.md). Изменения локальные; старый статус этих находок ниже относится к первоначальному аудиту. Неопределённые и поздние платежи имеют документированный ручной путь проверки.
